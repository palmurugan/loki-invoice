...
/**
 * REST controller for managing {@link com.way2invoice.bms.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
  ...
  public ResponseEntity<CustomerDTO> createCustomer(@Valid @RequestBody CustomerDTO customerDTO)
    ...
    if (customerDTO.getId() != null) {
      throw new BadRequestAlertException("A new customer cannot already have an ID", ENTITY_NAME,
          "idexists");
    }
    customerDTO.setClientId(1L);
