...
/**
 * REST controller for managing {@link com.way2invoice.bms.domain.AccountType}.
 */
@RestController
@RequestMapping("/api")
public class AccountTypeResource {
    ...
    public ResponseEntity<List<AccountTypeDTO>> getAllAccountTypes(Pageable pageable) {
