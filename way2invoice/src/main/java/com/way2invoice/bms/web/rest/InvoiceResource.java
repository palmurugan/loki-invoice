...
/**
 * REST controller for managing {@link com.way2invoice.bms.domain.Invoice}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceResource {
     ...
     * invoiceDTO, or with status {@code 400 (Bad Request)} if the invoice has already an ID.
    ...
    public ResponseEntity<InvoiceDTO> createInvoice(@Valid @RequestBody InvoiceDTO invoiceDTO)
        ...
        if (invoiceDTO.getId() != null) {
            throw new BadRequestAlertException("A new invoice cannot already have an ID",
     ...
     * invoiceDTO, or with status {@code 400 (Bad Request)} if the invoiceDTO is not valid, or with
     * status {@code 500 (Internal Server Error)} if the invoiceDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/invoices")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of invoices in
     * body.
     */
    @GetMapping("/invoices")
    public ResponseEntity<List<InvoiceDTO>> getAllInvoices(Pageable pageable,
        ...
        Page<InvoiceDTO> page = invoiceService.findAll(invoiceType, pageable);
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the invoiceDTO,
