...
const dynamicForm = [
    ...
    { component: 'dropdown', name: 'accountFromId', label: 'Paying From', required: 'true', apiURL: '/api/accounts?accountType=Customer', isChildForm: true, parentForm: "payment" },
    { component: 'dropdown', name: 'accountToId', label: 'Paying To', required: 'true', apiURL: '/api/accounts?accountType=Vendor', isChildForm: true, parentForm: "payment" },
    { component: 'dropdown', name: 'invoiceId', label: 'Bill', required: 'true', apiURL: '/api/invoices?invoiceType=Purchase' },
...
class Payment extends Component {
    ...
    resetState = () => this.setState({ values: { payment: {} }, showNotification: true, notification: { message: 'Payment Created Successfully' } });
    ...
    render = () => {
        return (
            <form onSubmit={this.handleSubmit} >
                <PageHolder title="Payment" breadCrumbData={breadCrumbData} actionEnabled="true" updateMode={this.state.updateMode}>
